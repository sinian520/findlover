...
from.models import user,matchmaker,memberprice,partyapply,partymessage,xinwen,text,friends,userdynamic,comment
...
class  matchmaker_admin(admin.ModelAdmin):
    list_display = ['name','password','tele','live','emile','status']
admin.site.register(matchmaker,matchmaker_admin)
...
class partymessage_admin(admin.ModelAdmin):
    list_display = ['tele','evaluate','partyid','participant']
...
class comment_admin(admin.ModelAdmin):
    list_display = ['time','Text','Form_uid','to_uid','dynamic']
